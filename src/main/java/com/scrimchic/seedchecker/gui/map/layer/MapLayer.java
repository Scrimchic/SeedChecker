 ...
 * is able to draw at all, so implementations do not have to repeat those checks.
 */
public interface MapLayer {
     ...
     */
    String unavailableReason(WorldContext context, MapViewport viewport, ChunkRange visible);

    /**
     * Draws the layer. Only called when the layer is enabled and
     * {@link #unavailableReason} returned {@code null}.
     */
    void render(MapCanvas canvas, MapViewport viewport, ChunkRange visible, WorldContext context);
}
